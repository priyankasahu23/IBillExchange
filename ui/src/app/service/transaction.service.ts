...
export class TransactionService {
  ...
  private createTransactionUrl = 'https://localhost:8888/api/v5_2/flow/9B2560851C8B';  // Update with actual backend URL
 ...
 // Initialize with default values
  ...
  getStatusRequest(request: TransactionStatus): Observable<any> {
    ...
    fetchTransactionResult(clientRequestId: string): Observable<any> {
      ...
      const url = `https://localhost:8888/api/v5_2/flow/9B2560851C8B/${clientRequestId}/result`;
